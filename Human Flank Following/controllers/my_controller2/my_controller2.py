...
while robot.step(timestep) != -1:
    ...
    lidar_vr = lidar_v[0:6]
    
    lidar_vf = lidar_v[6:14]
    
    lidar_vl = lidar_v[14:20]
    ...
    if    gps_v1 > 0.9:
            ...
            for i in range(number_of_objects) :
                ...
                if model.decode(encoding) == aa :
                    ...
                    # if posA[1] < 100 :
                    if 0 < posA[1] <= 160 :
                        if resultL0 < 5 or resultL1 < 5 or resultL2 < 5 or resultF2 < 5:
                                roll_disturbance = - 1.0
                    if 160 < posA[1] <= 200:
                        if resultF2 or resultF1:
                                roll_disturbance = -1.0
                    if posA[1] > 200:
                          
                        if resultF0 <  5 or resultR2 < 5 or resultR1 < 5:
                                roll_disturbance = -1.0
                            
                    # if posA[1] > 280 :
                         # if 200 <= posA[1] < 360:
                                # if resultR0 < 5 or resultR1 < 5 or resultR2 < 5 or resultF0 < 5:
                                    # roll_disturbance =  1.0
                         # if 160 < posA[1] <= 200:
                                # if resultF2 or resultF1:
                                    # roll_disturbance = 1.0
                         # if posA[1] < 160:
                                ...
                                # if resultF2 <  5 or resultL2 < 5 or resultL1 < 5:
                                    # roll_disturbance = 1.0       
                    ...
                    # if  resultF0 <= 5 and  200 < posA[1]  :
                       
                            # yaw_disturbance = 1.3
                    
                    # if  resultF2 <= 5 and   posA[1]  <160 :
                        # yaw_disturbance = -1.3
